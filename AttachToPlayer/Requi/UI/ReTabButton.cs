...
namespace ReMod.Core.UI
{
    public class ReTabButton : UiElement
    {
        ...
        protected ReTabButton(string name, string tooltip, string pageName) : base(TabButtonPrefab, TabButtonPrefab.transform.parent, $"Page_{name}")
        {
        ...
        public static ReTabButton Create(string name, string tooltip, string pageName)
        {
            return new ReTabButton(name, tooltip, pageName);
        }
    }
}
