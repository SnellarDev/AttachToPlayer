...
namespace ReMod.Core.VRChat
{
    public static class QuickMenuEx
    {
        ...
        private static UserInteractMenu userInteractMenu;
        ...
        public static UserInteractMenu targetintsance
        {
            get
            {
                if (userInteractMenu == null)
                {
                    userInteractMenu = Object.FindObjectOfType<UserInteractMenu>();
                }
                return userInteractMenu;
            }
        }
